        ...
        <>
           ...
           <div className="bg-cover bg-center bg-no-repeat bg-[url('/blur.png')] h-[316px]">
            ...
            <p className="text-sm text-[#9F9F9F] font-serif">
                Lorem ipsum, dolor sit amet consectetur adip elit. Saepe, aperiam similique quas libero quit officia dolor eius quam?
                Exercitation <br />nostrum ut dolores blanditiis a saepe culpa sunt, officia aliquid voluptates?
                 Lorem ipsum dolor sit amet consectetur adipisicing elit. <br />hihi Fuga dolores laboriosam, blanditiis 
                 beatae accusantium vero omnis quae illo! Quaerat officiis eaque dolore unde eius fuga et <br />aliquid quae cum minu Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae assumenda eius aut voluptates vel
                  ipsam, nisi <br />totam usoll ullam dolore molestias provident magnam. Lorem,
...
<h1 className="md:text-3xl md:w-[506px] md:h-[45px] my-5">Exploring new ways of decorating</h1>
<p className="text-sm text-[#9F9F9F] font-serif">
...
<span className="text-base flex"> <BsCalendar2DateFill className="my-0 mx-1"/> Wood </span>
     ...
     <div className="my-16"> 
      ...
      <h1 className="md:text-3xl md:w-[632px] h-[45px]">Handmade pieces that took time to make</h1>
