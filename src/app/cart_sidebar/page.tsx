...
<div className="flex md:flex-col my-9 md:mx-5 md:space-y-7 rounded-lg">

<img src="chairs3.png" width={76} height={80} alt="" className="mx-2  bg-[#F9F1E7]"/>
<img src="sofa 3.png" width={83} height={115} alt="" className="mx-2 bg-[#F9F1E7]" />
<img src="Outdoorsofa.png" width={83} height={55} alt="" className="mx-2 bg-[#F9F1E7]" />
<img src="Maya.png" width={83} height={55} alt="" className="mx-2 bg-[#F9F1E7]" />
...
<div className="items-center justify-center">
 ...
 <div className="mx-5 my-4 md:mx-12">
     ...
     <p className="text-[#9F9F9F] text-sm relative "> | Customer Review</p> 
